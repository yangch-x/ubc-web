...
//                 onOk() {
//                     //此处id按实际字段名取
//                     invoiceService.deletes(selection.map((el) => el.id)).then((res) => {
...
//                 data={formData}
//                 columns={[
//                     { type: "treeselect@w200", prop: "customerCode", label: "Customer Code", disabled: ({ value, data }) => {} },
//                     { type: "input@w200", prop: "houseBlNum", label: "Bill of Landing", config: { allowClear: true } },
//                     { type: "input@w200", prop: "masterPo", label: "Master PO", config: { allowClear: false } },
...
//                     { type: "input@w200", prop: "origCountry", label: "Country of Origin" },
...
//                     { type: "button-primary", prop: "search", value: "search", config: { icon: <SearchOutlined /> } },
//                 ]}
//             />
//             <Region
//                 onEvent={regionEvent}
...
//                     {
//                         render() {
//                             return [{ type: "progress" }, { type: "button", value: "编辑" }, { type: "space" }]
//                         },
//                     },
//                 ]}
//             />
